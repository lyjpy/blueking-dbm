...
ITSM_V4_APIGW_DOMAIN = env.ITSM_V4_APIGW_DOMAIN
...
HADBV2_APIGW_DOMAIN = env.HADBV2_APIGW_DOMAIN or ESB_DOMAIN_TPL.format("hadbv2")
...
# gcs/scr平台，后续可能会下架掉这两个系统
GCS_APIGW_DOMAIN = env.GCS_APIGW_DOMAIN or ESB_DOMAIN_TPL.format("gcs")
GCS_DIRECT_APIGW_DOMAIN = env.GCS_DIRECT_APIGW_DOMAIN or ESB_DOMAIN_TPL.format("gcs")
SCR_APIGW_DOMAIN = env.SCR_APIGW_DOMAIN or ESB_DOMAIN_TPL.format("scr")
